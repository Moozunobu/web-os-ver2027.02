    ...
    switch (id) {
      case 'aboad':
        return (
          <svg viewBox="0 0 100 100" className="w-full h-full drop-shadow-sm">
            <defs>
              <linearGradient id="aboadGradSimple" x1="0%" y1="0%" x2="100%" y2="100%">
                <stop offset="0%" stopColor="#4f46e5" />
                <stop offset="100%" stopColor="#0284c7" />
              </linearGradient>
            </defs>
            <rect x="8" y="8" width="84" height="84" rx="24" fill="url(#aboadGradSimple)" />
            {/* Sleek Minimalist A Logo */}
            <path
              d="M 50 24 L 72 72 H 60.5 L 50 48 L 39.5 72 H 28 Z"
              fill="#ffffff"
            />
            <rect x="38" y="58" width="24" height="6" rx="3" fill="#38bdf8" />
          </svg>
        );
      ...
      case 'abordstore':
        return (
          <svg viewBox="0 0 100 100" className="w-full h-full">
            <defs>
              <linearGradient id="storeGradAbord" x1="0%" y1="0%" x2="100%" y2="100%">
                <stop offset="0%" stopColor="#2563eb" />
                <stop offset="100%" stopColor="#1d4ed8" />
              </linearGradient>
              <linearGradient id="bagGradFluent" x1="0%" y1="0%" x2="0%" y2="100%">
                <stop offset="0%" stopColor="#ffffff" />
                <stop offset="100%" stopColor="#f1f5f9" />
              </linearGradient>
            </defs>
            <rect x="12" y="12" width="76" height="76" rx="18" fill="url(#storeGradAbord)" />
            {/* Shopping Bag handle */}
            <path d="M 38 40 C 38 24, 62 24, 62 40" fill="none" stroke="url(#bagGradFluent)" strokeWidth="5.5" strokeLinecap="round" />
            {/* Bag Body */}
            <path d="M 28 40 L 72 40 L 76 78 L 24 78 Z" fill="url(#bagGradFluent)" opacity="0.95" />
            {/* Abord Store Emblem - Sleek "A" Crest */}
            <path d="M 50 48 L 61 65 H 54 L 50 58 L 46 65 H 39 Z" fill="#2563eb" />
            <rect x="44" y="59" width="12" height="2.5" fill="#2563eb" rx="1" />
          </svg>
        );
      ...
      case 'start':
        ...
        return (
          <svg viewBox="0 0 100 100" className="w-full h-full">
            <defs>
              <linearGradient id="startGradAbord" x1="0%" y1="0%" x2="100%" y2="100%">
                <stop offset="0%" stopColor="#3b82f6" />
                <stop offset="100%" stopColor="#1d4ed8" />
              </linearGradient>
            </defs>
            <rect x="14" y="14" width="72" height="72" rx="20" fill="url(#startGradAbord)" />
