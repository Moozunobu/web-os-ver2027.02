...
import { Save, FilePlus, FolderOpen, Trash2, Download } from 'lucide-react';
        ...
        <div className="flex items-center gap-1 mt-1 sm:mt-0">
          ...
          <button
            onClick={() => {
              ...
              downloadFileAndOpenGitHub(name, content, 'text/plain;charset=utf-8');
            }}
            className="flex items-center gap-1.5 px-2.5 py-1.5 bg-emerald-600 hover:bg-emerald-700 text-white rounded font-medium transition-colors"
            title="PCへダウンロードしてGitHubで開く"
            id="notepad-btn-download"
          >
